...
This project is indexed by GitNexus as **find_anomali** (132 symbols, 168 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
